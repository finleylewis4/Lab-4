...
def remove_punct(text):
    ...
    'goSouTh'
    """
    for c in string.punctuation:        #DONE
        text= text.replace(c,"")
    return text
...
def exit_leads_to(exits, direction):
    ...
    dic=exits[direction]
    r=rooms[dic]
    return r['name']#DONE - why not on one line?
...
def print_menu_line(direction, leads_to):
    ...
    """
    print("Go "+direction.upper()+" to "+leads_to+".") #DONE
...
def menu(exits):
    ...
    while True:
        print_menu(exits)
        user_input=normalise_input(input("Where do you want to go?"))
...
def move(exits, direction):
    ...
    False
    """
    return rooms[exits[direction]] #NOT DONE
